[http://localhost:8000/home_admin_hr](http://localhost:8000/home_admin_hr) (make sure you use the name "localhost" and not "127.0.0.1" so the Microsoft auth redirect works)
